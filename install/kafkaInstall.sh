...
tmp=""
for ip in $(cat ${CONF_DIR}/iplists.properties);do
{
...
sed -i "s#^kafka-manager.zkhosts=\".*#kafka-manager.zkhosts=\"${tmp}\"#g" ${KAFKA_SOURCE_DIR}/kafka/kafka-manager/conf/application.conf
